...
I use the function: ncol(). There is 14 columns.

4. Show the dataset so that we can see how R interprets each column.
I use the function: glimpse()
...
As seen below I have tried to use both the mean() base-R function and the`summarize()` tidyverse function.
Both functions give me the same result: The avaerage duration of reign of all rulers is 18.92157 years.
...
By using the code below, we have come to the concklusion that 24 kings enjoyed a longer-than-averiage duration of reign.
Under Step 2 we have created a tibble with the names of the 24 kings.
